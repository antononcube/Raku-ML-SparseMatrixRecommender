...
class ML::SparseMatrixRecommender::CoreSMR
    ...
    method ingest-smr-matrix-csv-file(Str $fileName,
    ...
    #| A modified version of this function's code is used in C<LSATopicSMR::ingest-lsa-matrix-csv-file>.
    ...
    multi method classify-by-profile(Str $tagType,
        ...
        # Pick max-top labels
        if $max-number-of-labels ~~ Numeric:D && $max-number-of-labels > 0 && $max-number-of-labels < @clRecs.elems {
